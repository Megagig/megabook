    ...
    <section className="flex flex-col lg:flex-row dark:text-slate-100 items-center">
      <div className="text my-5">
        ...
        <p className="text-2xl my-7 px-1 dark:text-slate-300">
          MegaBook: The Leading Source for Computer Science and Programming
          eBooks. Explore the latest and highest-rated digital books. Stay ahead
          with the newest releases in the field.
        </p>
        <Link
          to="/products"
          type="button"
